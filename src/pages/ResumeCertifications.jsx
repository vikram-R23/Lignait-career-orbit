...
const ResumeCertifications = () => {
  ...
  // Helper to determine active state style for INNER editor sidebar
  ...
  return (
    <div className="bg-[#06457F] text-white font-['Space_Grotesk'] h-screen w-full flex overflow-hidden antialiased relative">
      ...
      {/* --- MAIN SIDEBAR (Standardized with Compact Profile) --- */}
            ...
            <div className="p-4">
              ...
              <ul className="space-y-1">
                ...
                <li>
                  ...
                  <button onClick={() => navigate('/resume-certifications')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-white bg-[#0474C4] shadow-md text-left transition-all">
                    <div className="flex items-center gap-3">
